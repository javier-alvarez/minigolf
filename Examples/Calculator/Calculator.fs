...
let clicked () =
  ...
  if Controls.LastClickedButton = key0 then
    Controls.SetTextBoxText(t, Controls.GetTextBoxText(t) + "0")
  elif Controls.LastClickedButton = key1 then
    Controls.SetTextBoxText(t, Controls.GetTextBoxText(t) + "1")
  elif Controls.LastClickedButton = key2 then
    Controls.SetTextBoxText(t, Controls.GetTextBoxText(t) + "2")
  elif Controls.LastClickedButton = key3 then
    Controls.SetTextBoxText(t, Controls.GetTextBoxText(t) + "3")
  elif Controls.LastClickedButton = key4 then
    Controls.SetTextBoxText(t, Controls.GetTextBoxText(t) + "4")
  elif Controls.LastClickedButton = key5 then
    Controls.SetTextBoxText(t, Controls.GetTextBoxText(t) + "5")
  elif Controls.LastClickedButton = key6 then
    Controls.SetTextBoxText(t, Controls.GetTextBoxText(t) + "6")
  elif Controls.LastClickedButton = key7 then
    Controls.SetTextBoxText(t, Controls.GetTextBoxText(t) + "7")
  elif Controls.LastClickedButton = key8 then
    Controls.SetTextBoxText(t, Controls.GetTextBoxText(t) + "8")
  elif Controls.LastClickedButton = key9 then
    Controls.SetTextBoxText(t, Controls.GetTextBoxText(t) + "9")
  elif Controls.LastClickedButton = keytochka then
    Controls.SetTextBoxText(t, Controls.GetTextBoxText(t) + ".")
  elif Controls.LastClickedButton = keyplusminus then
    if p = 0 then
      Controls.SetTextBoxText(t, "-" + Controls.GetTextBoxText(t))
      p <- 1
    else
      Controls.SetTextBoxText(t, string (abs(float (Controls.GetTextBoxText(t)))))
      p <- 0   
    ...
    Controls.SetTextBoxText(t, string (sqrt(float(Controls.GetTextBoxText(t)))))
    ...
    Controls.SetTextBoxText(t, Controls.GetTextBoxText(t).Substring(1, Controls.GetTextBoxText(t).Length-1))
